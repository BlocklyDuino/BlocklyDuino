...
{
	var colorSensorNumber=this.getFieldValue('sensorNumber');
...
Blockly.Arduino['Measure']=function()
{
	...
	Blockly.Arduino.definitions_['moveRightFunction_' + colorSensorNumber]="Adafruit_TCS34725 tcs_"+colorSensorNumber+" = Adafruit_TCS34725(TCS34725_INTEGRATIONTIME_50MS, TCS34725_GAIN_4X);\n";
	...
	Blockly.Arduino.setups_['tcs_begin_'+colorSensorNumber]="tcs_"+colorSensorNumber+".begin();"
