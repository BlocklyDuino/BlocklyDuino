...
goog.DEPENDENCIES_ENABLED && (goog.included_ = {}, goog.dependencies_ = {
        ...
        try {
            ...
            goog.moduleLoaderState_.declareLegacyNamespace ?
                goog.constructNamespace_(d, c) : goog.SEAL_MODULE_EXPORTS && Object.seal && Object.seal(c);
            goog.loadedModules_[d] = c;
            if (goog.moduleLoaderState_.declareTestMethods)
                for (var e in c)
                    if (0 === e.indexOf("test", 0) || "tearDown" == e || "setUp" == e || "setUpPage" == e || "tearDownPage" == e) goog.global[e] = c[e]
        } finally {
    ...
    function(a) {
        ...
        for (f = 0; f < b.length; f++)
            if (e = b[f]) d.pathIsModule[e] ? goog.importModule_(goog.basePath + e) : goog.importScript_(goog.basePath +
                e);
...
goog.style.getContainerOffsetToScrollInto = function(a, b, c) {
    ...
    var k = b.scrollLeft,
        l = b.scrollTop;
    if (b == goog.dom.getDocument().body || b == goog.dom.getDocument().documentElement) k = e.x + f.left, l = e.y + f.top, goog.userAgent.IE && !goog.userAgent.isDocumentModeOrHigher(10) && (k += f.left, l += f.top);
    c ? (k += g - h / 2, l += d - a / 2) : (k += Math.min(g,
        Math.max(g - h, 0)), l += Math.min(d, Math.max(d - a, 0)));
...
goog.testing.watchers.signalClockReset = function() {
    for (var a = goog.testing.watchers.resetWatchers_, b = 0; b < a.length; b++) goog.testing.watchers.resetWatchers_[b]()
};
...
goog.cssom.getAllCss_ = function(a, b) {
    for (var c = [], d = goog.cssom.getAllCssStyleSheets(a), e = 0; a = d[e]; e++) {
        ...
        if (f && f.length) {
            if (!b) var g = 0;
            for (var h = 0, k = f.length, l; h < k; h++) l = f[h], b && !l.href ? (l = goog.cssom.getCssTextFromCssRule(l), c.push(l)) : l.href || (l.style && (l.parentStyleSheet || (l.style["-closure-parent-stylesheet"] = a), l.style["-closure-rule-index"] = g), c.push(l)), b || g++
        }
    }
    return b ? c.join(" ") : c
};
...
Blockly.Bubble.prototype.bubbleMouseMove_ = function(a) {
    this.autoLayout_ = !1;
    this.relativeLeft_ = this.workspace_.RTL ? this.dragDeltaX - a.clientX : this.dragDeltaX + a.clientX;
...
Blockly.Bubble.prototype.layoutBubble_ = function() {
    ...
    this.workspace_.RTL ? this.anchorX_ - c.viewLeft - a - this.width_ < Blockly.Scrollbar.scrollbarThickness ? a = this.anchorX_ - c.viewLeft - this.width_ - Blockly.Scrollbar.scrollbarThickness : this.anchorX_ - c.viewLeft - a > c.viewWidth && (a = this.anchorX_ - c.viewLeft - c.viewWidth) : this.anchorX_ + a < c.viewLeft ? a = c.viewLeft - this.anchorX_ : c.viewLeft + c.viewWidth < this.anchorX_ + a + this.width_ +
        Blockly.BlockSvg.SEP_SPACE_X + Blockly.Scrollbar.scrollbarThickness && (a = c.viewLeft + c.viewWidth - this.anchorX_ - this.width_ - Blockly.Scrollbar.scrollbarThickness);
...
Blockly.Icon.prototype.iconClick_ = function(a) {
    this.block_.isInFlyout || Blockly.isRightButton(a) || this.setVisible(!this.isVisible())
};
...
Blockly.Connection.prototype.connect = function(a) {
    ...
    var d;
    this.isSuperior() ? (c = this.sourceBlock_, d = a.sourceBlock_) : (c = a.sourceBlock_, d =
        this.sourceBlock_);
...
Blockly.Connection.prototype.closest = function(a, b, c) {
    function d(b) {
        var c = e[b];
        if ((c.type == Blockly.OUTPUT_VALUE || c.type == Blockly.PREVIOUS_STATEMENT) && c.targetConnection || c.type == Blockly.INPUT_VALUE && c.targetConnection && !c.targetBlock().isMovable() || !q.checkType_(c)) return !0;
        c = c.sourceBlock_;
        do {
            if (l == c) return !0;
            c = c.getParent()
...
Blockly.Connection.prototype.setHidden = function(a) {
    (this.hidden_ = a) && this.inDB_ ? this.dbList_[this.type].removeConnection_(this) : a || this.inDB_ || this.dbList_[this.type].addConnection_(this)
};
...
Blockly.Field.prototype.init = function(a) {
    this.sourceBlock_ || (this.sourceBlock_ = a, this.fieldGroup_ = Blockly.createSvgElement("g", {}, null), this.visible_ || (this.fieldGroup_.style.display = "none"), this.borderRect_ = Blockly.createSvgElement("rect", {
        ...
        "class": "blocklyText"
    }, this.fieldGroup_), this.updateEditable(), a.getSvgRoot().appendChild(this.fieldGroup_), this.mouseUpWrapper_ = Blockly.bindEvent_(this.fieldGroup_,
        "mouseup", this, this.onMouseUp_), this.updateTextNode_())
};
...
Blockly.Tooltip.onMouseMove_ = function(a) {
    if (Blockly.Tooltip.element_ && Blockly.Tooltip.element_.tooltip && 0 == Blockly.dragMode_ && !Blockly.WidgetDiv.isVisible())
        ...
        } else Blockly.Tooltip.poisonedElement_ != Blockly.Tooltip.element_ && (clearTimeout(Blockly.Tooltip.showPid_), Blockly.Tooltip.lastX_ = a.clientX, Blockly.Tooltip.lastY_ =
            a.clientY, Blockly.Tooltip.showPid_ = setTimeout(Blockly.Tooltip.show_, Blockly.Tooltip.HOVER_MS))
};
...
Blockly.Tooltip.show_ = function() {
    ...
    if (Blockly.Tooltip.DIV) {
        ...
        d + Blockly.Tooltip.DIV.offsetHeight > b.height && (d -= Blockly.Tooltip.DIV.offsetHeight + 2 * Blockly.Tooltip.OFFSET_Y);
...
Blockly.FieldLabel.prototype.init = function(a) {
    this.sourceBlock_ || (this.sourceBlock_ = a, this.textElement_ = Blockly.createSvgElement("text", {
        "class": "blocklyText"
    }, null), this.visible_ || (this.textElement_.style.display = "none"), a.getSvgRoot().appendChild(this.textElement_), this.textElement_.tooltip = this.sourceBlock_, Blockly.Tooltip.bindMouseEvents(this.textElement_), this.updateTextNode_())
};
...
Blockly.Trashcan.prototype.position = function() {
    var a = this.workspace_.getMetrics();
    a && (this.left_ = this.workspace_.RTL ? this.MARGIN_SIDE_ : a.viewWidth + a.absoluteLeft - this.WIDTH_ - this.MARGIN_SIDE_, this.top_ = a.viewHeight + a.absoluteTop - (this.BODY_HEIGHT_ + this.LID_HEIGHT_) - this.MARGIN_BOTTOM_, this.svgGroup_.setAttribute("transform", "translate(" + this.left_ + "," + this.top_ + ")"))
};
    ...
    for (var c = 0, d; d = a.inputList[c]; c++)
        for (var e = 0, f; f = d.fieldRow[e]; e++)
            if (f.name && f.EDITABLE) {
                ...
                b.appendChild(g)
            } if (c = a.getCommentText()) c = goog.dom.createDom("comment", null, c), "object" == typeof a.comment && (c.setAttribute("pinned", a.comment.isVisible()),
        d = a.comment.getBubbleSize(), c.setAttribute("h", d.height), c.setAttribute("w", d.width)), b.appendChild(c);
    a.data && (c = goog.dom.createDom("data", null, a.data), b.appendChild(c));
    for (c = 0; d = a.inputList[c]; c++) {
        var h, e = !0;
        d.type != Blockly.DUMMY_INPUT && (f = d.connection.targetBlock(), d.type == Blockly.INPUT_VALUE ? h = goog.dom.createDom("value") : d.type == Blockly.NEXT_STATEMENT && (h = goog.dom.createDom("statement")), f && (h.appendChild(Blockly.Xml.blockToDom_(f)), e = !1), h.setAttribute("name", d.name), e || b.appendChild(h))
    }
    a.inputsInlineDefault !=
        a.inputsInline && b.setAttribute("inline", a.inputsInline);
...
Blockly.Xml.domToBlockHeadless_ = function(a, b, c) {
    ...
    for (var g = null, f = 0, h; h = b.childNodes[f]; f++)
        if (3 != h.nodeType || !h.data.match(/^\s*$/)) {
            for (var g = null, k = 0, l; l = h.childNodes[k]; k++) 3 == l.nodeType && l.data.match(/^\s*$/) ||
                (g = l);
            ...
            switch (h.nodeName.toLowerCase()) {
                ...
                case "comment":
                    ...
                    q && setTimeout(function() {
                        d.comment && d.comment.setVisible && d.comment.setVisible("true" == q)
                    }, 1);
                    g = parseInt(h.getAttribute("w"), 10);
                    h = parseInt(h.getAttribute("h"), 10);
                    !isNaN(g) && !isNaN(h) && d.comment && d.comment.setVisible && d.comment.setBubbleSize(g, h);
                    break;
                case "data":
...
Blockly.WorkspaceSvg.prototype.addChangeListener = function(a) {
    return Blockly.bindEvent_(this.getCanvas(), "blocklyWorkspaceChange", null, a)
};
...
Blockly.Warning.prototype.setVisible = function(a) {
    if (a != this.isVisible())
        if (a) {
            ...
            this.bubble_ = new Blockly.Bubble(this.block_.workspace, b, this.block_.svgPath_, this.iconX_, this.iconY_, null, null);
            if (this.block_.RTL) {
                a = b.getBBox().width;
                for (var c = 0, d; d = b.childNodes[c]; c++) d.setAttribute("text-anchor", "end"), d.setAttribute("x", a + Blockly.Bubble.BORDER_WIDTH)
            }
            this.updateColour();
            b = this.bubble_.getBubbleSize();
            this.bubble_.setBubbleSize(b.width,
                b.height)
...
Blockly.Warning.prototype.removeText = function(a) {
    void 0 !== this.text_[a] && (delete this.text_[a], 0 === Object.keys(this.text_).length || 1 === Object.keys(this.text_).length && !this.text_.default_ ? this.dispose() : this.isVisible() && (this.setVisible(!1), this.setVisible(!0)))
};
...
Blockly.Block.prototype.fill = function(a, b) {
    ...
    if (b) {
        ...
        goog.asserts.assertObject(c,
            'Error: "%s" is an unknown language block.', b);
        goog.mixin(this, c)
    }
...
Blockly.BlockSvg.terminateDrag_ = function() {
    ...
    if (2 == Blockly.dragMode_ && a) {
        ...
        a.setDragging_(!1);
        a.render();
        a.workspace && a.workspace.options.gridOptions && a.workspace.options.gridOptions.snap && goog.Timer.callOnce(a.snapToGrid_, Blockly.BUMP_DELAY / 2, a);
    ...
    if (!this.workspace.options.readOnly && this.contextMenu) {
        ...
        if (this.isDeletable() && this.isMovable() && !b.isInFlyout) {
            ...
            this.isEditable() && !this.collapsed_ && this.workspace.options.comments && (d = {
                enabled: !0
            }, this.comment ? (d.text = Blockly.Msg.REMOVE_COMMENT, d.callback =
                function() {
...
Blockly.BlockSvg.prototype.onMouseMove_ = function(a) {
    ...
    Blockly.doCommand(function() {
        if (!("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button)) {
            ...
            1 == Blockly.dragMode_ && Math.sqrt(Math.pow(c, 2) + Math.pow(d, 2)) > Blockly.DRAG_RADIUS && (Blockly.dragMode_ = 2, Blockly.longStop_(), b.setParent(null), b.setDragging_(!0), b.workspace.recordDeleteAreas());
            if (2 == Blockly.dragMode_) {
                var e = b.startDragX + c,
                    f = b.startDragY +
                    d;
                b.getSvgRoot().setAttribute("transform", "translate(" + e + ", " + f + ")");
                ...
                Blockly.highlightedConnection_ && Blockly.highlightedConnection_ != g && (Blockly.highlightedConnection_.unhighlight(), Blockly.highlightedConnection_ = null, Blockly.localConnection_ =
                    null);
                g && g != Blockly.highlightedConnection_ && (g.highlight(), Blockly.highlightedConnection_ = g, Blockly.localConnection_ = h);
...
Blockly.BlockSvg.disposeUiStep_ = function(a, b) {
    ...
    1 < c ? goog.dom.removeNode(a) : (a.setAttribute("transform", "translate(" + (a.translateX_ + (b ? -1 : 1) * a.bBox_.width / 2 * c + ", " + (a.translateY_ + a.bBox_.height * c)) + ") scale(" + (1 - c) + ")"), setTimeout(function() {
...
Blockly.BlockSvg.prototype.connectionUiEffect = function() {
    ...
    var a = Blockly.getSvgXY_(this.svgGroup_);
    this.outputConnection ? (a.x += this.RTL ? 3 : -3, a.y += 13) : this.previousConnection && (a.x += this.RTL ? -23 : 23, a.y += 3);
...
Blockly.BlockSvg.connectionUiStep_ = function(a) {
    ...
    1 < b ? goog.dom.removeNode(a) : (a.setAttribute("r", 25 * b), a.style.opacity = 1 - b, setTimeout(function() {
        Blockly.BlockSvg.connectionUiStep_(a)
    }, 10))
};
...
Blockly.BlockSvg.prototype.updateDisabled = function() {
    ...
    this.disabled || this.getInheritedDisabled() ? a || (Blockly.addClass_(this.svgGroup_, "blocklyDisabled"), this.svgPath_.setAttribute("fill", "url(#blocklyDisabledPattern)")) : a && (Blockly.removeClass_(this.svgGroup_, "blocklyDisabled"), this.updateColour());
...
Blockly.BlockSvg.prototype.setWarningText = function(a, b) {
    this.setWarningText.pid_ && (clearTimeout(this.setWarningText.pid_), this.setWarningText.pid_ = 0);
    if (2 == Blockly.dragMode_) {
        var c = this;
        ...
        var d = !1;
        goog.isString(a) ? (this.warning || (this.warning = new Blockly.Warning(this), d = !0), this.warning.setText(a, b)) : this.warning && void 0 === b ? (this.warning.dispose(), d = !0) : this.warning && (this.warning.removeText(b),
            d = !0);
...
Blockly.BlockSvg.prototype.renderDrawTop_ = function(a, b, c, d) {
    ...
    this.previousConnection && (a.push("H", Blockly.BlockSvg.NOTCH_WIDTH - 15), b.push("H", Blockly.BlockSvg.NOTCH_WIDTH - 15),
        a.push(Blockly.BlockSvg.NOTCH_PATH_LEFT), b.push(Blockly.BlockSvg.NOTCH_PATH_LEFT_HIGHLIGHT), this.previousConnection.moveTo(c.x + (this.RTL ? -Blockly.BlockSvg.NOTCH_WIDTH : Blockly.BlockSvg.NOTCH_WIDTH), c.y));
    a.push("H", d);
    b.push("H", d - .5);
    this.width = d
};
Blockly.BlockSvg.prototype.renderDrawRight_ = function(a, b, c, d, e, f, g) {
    for (var h, k = 0, l, q, m = 0, p; p = f[m]; m++) {
        ...
        if (this.isCollapsed()) {
            ...
            for (var r = 0; n = p[r]; r++) l = k + Blockly.BlockSvg.FIELD_HEIGHT, p.thicker && (l += Blockly.BlockSvg.INLINE_PADDING_Y), h = this.renderFields_(n.fieldRow, h, l), n.type != Blockly.DUMMY_INPUT && (h += n.renderWidth + Blockly.BlockSvg.SEP_SPACE_X), n.type == Blockly.INPUT_VALUE && (c.push("M", h - Blockly.BlockSvg.SEP_SPACE_X + "," + (k + Blockly.BlockSvg.INLINE_PADDING_Y)), c.push("h", Blockly.BlockSvg.TAB_WIDTH - 2 - n.renderWidth), c.push(Blockly.BlockSvg.TAB_PATH_DOWN),
                c.push("v", n.renderHeight + 1 - Blockly.BlockSvg.TAB_HEIGHT), c.push("h", n.renderWidth + 2 - Blockly.BlockSvg.TAB_WIDTH), c.push("z"), this.RTL ? (d.push("M", h - Blockly.BlockSvg.SEP_SPACE_X - 2.5 + Blockly.BlockSvg.TAB_WIDTH - n.renderWidth + "," + (k + Blockly.BlockSvg.INLINE_PADDING_Y + .5)), d.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL), d.push("v", n.renderHeight - Blockly.BlockSvg.TAB_HEIGHT + 2.5), d.push("h", n.renderWidth - Blockly.BlockSvg.TAB_WIDTH + 2)) : (d.push("M", h - Blockly.BlockSvg.SEP_SPACE_X + .5 + "," + (k + Blockly.BlockSvg.INLINE_PADDING_Y +
                    ...
                    q), n.connection.targetConnection && n.connection.tighten_());
        ...
        } else p.type == Blockly.INPUT_VALUE ? (n = p[0], l = k + Blockly.BlockSvg.FIELD_HEIGHT, n.align != Blockly.ALIGN_LEFT && (r = f.rightEdge - n.fieldWidth - Blockly.BlockSvg.TAB_WIDTH - 2 * Blockly.BlockSvg.SEP_SPACE_X, n.align == Blockly.ALIGN_RIGHT ? h += r : n.align == Blockly.ALIGN_CENTRE && (h += (r + h) / 2)), this.renderFields_(n.fieldRow,
            ...
            b.push("H", f.rightEdge - .5), l = e.x + (this.RTL ? -h : h + 1), q = e.y + k + 1, n.connection.moveTo(l, q), n.connection.targetConnection && (n.connection.tighten_(), this.width = Math.max(this.width, f.statementEdge + n.connection.targetBlock().getHeightWidth().width)), m == f.length - 1 || f[m + 1].type == Blockly.NEXT_STATEMENT) && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y), this.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), k += Blockly.BlockSvg.SEP_SPACE_Y);
        k += p.height
    }
...
Blockly.FieldTextInput.prototype.showEditor_ = function(a) {
    ...
    if (!b && (goog.userAgent.MOBILE || goog.userAgent.ANDROID || goog.userAgent.IPAD)) a = window.prompt(Blockly.Msg.CHANGE_VALUE_TITLE, this.text_), this.sourceBlock_ && this.changeHandler_ && (b = this.changeHandler_(a), void 0 !== b && (a = b)), null !== a && this.setText(a);
        ...
        a.onWorkspaceChangeWrapper_ = Blockly.bindEvent_(b,
            "blocklyWorkspaceChange", this, this.resizeEditor_)
    }
};
Blockly.FieldTextInput.prototype.onHtmlInputKeyDown_ = function(a) {
    var b = Blockly.FieldTextInput.htmlInput_;
    13 == a.keyCode ? Blockly.WidgetDiv.hide() : 27 == a.keyCode && (this.setText(b.defaultValue), Blockly.WidgetDiv.hide())
};
Blockly.FieldTextInput.prototype.onHtmlInputChange_ = function(a) {
    var b = Blockly.FieldTextInput.htmlInput_;
    27 != a.keyCode && (a = b.value, a !== b.oldValue_ ? (b.oldValue_ = a, this.setText(a), this.validate_()) : goog.userAgent.WEBKIT && this.sourceBlock_.render())
};
...
Blockly.FieldAngle.prototype.setChangeHandler = function(a) {
    ...
    if (a) {
        ...
        b = function(b) {
            var e = a.call(c, b);
            if (null === e) var f = e;
            else void 0 === e && (e = b), f = Blockly.FieldAngle.angleValidator.call(c, e), void 0 !== f && (f = e);
            return f === b ? void 0 : f
        }
...
Blockly.FieldAngle.prototype.onMouseMove = function(a) {
    ...
    b = Math.atan(-a / c);
    isNaN(b) || (b = goog.math.toDegrees(b), 0 > c ? b += 180 : 0 < a && (b += 360), Blockly.FieldAngle.ROUND && (b = Math.round(b / Blockly.FieldAngle.ROUND) * Blockly.FieldAngle.ROUND), 360 <= b && (b -= 360), b = String(b), Blockly.FieldTextInput.htmlInput_.value = b, this.setText(b))
};
...
Blockly.FieldVariable.prototype.setChangeHandler = function(a) {
    ...
    if (a) {
        ...
        b = function(b) {
            var e = a.call(c, b);
            if (null === e) var f = e;
            else void 0 === e && (e = b), f = Blockly.FieldVariable.dropdownChange.call(c, e), void 0 !== f && (f = e);
            return f === b ? void 0 : f
        }
...
Blockly.Realtime.addAuthUi_ = function(a) {
    a.style.background = "url(" + Blockly.pathToMedia + Blockly.Realtime.PROGRESS_URL_ + ") no-repeat center center";
        ...
        for (var b = Blockly.Realtime.document_.getCollaborators(), c = 0; c < b.length; c++) {
            var d = b[c],
                e = goog.dom.createDom("img", {
                    src: d.photoUrl || Blockly.pathToMedia + Blockly.Realtime.ANONYMOUS_URL_,
                    alt: d.displayName,
...
Blockly.Flyout.prototype.init = function(a) {
    ...
    this.eventWrappers_.concat(Blockly.bindEvent_(this.targetWorkspace_.getCanvas(), "blocklyWorkspaceChange", this, this.filterForCapacity_));
    ...
    if (this.width_ != a) {
        for (d = 0; e = c[d]; d++) {
            ...
            e.flyoutRect_ && (e.flyoutRect_.setAttribute("width", f.width), e.flyoutRect_.setAttribute("height",
                f.height), e.flyoutRect_.setAttribute("x", this.RTL ? g.x - f.width : g.x), e.flyoutRect_.setAttribute("y", g.y))
        }
        this.width_ = a;
        Blockly.fireUiEvent(window, "resize")
    }
...
Blockly.Flyout.prototype.onMouseMoveBlock_ = function(a) {
    if ("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button) a.stopPropagation();
        ...
        Math.sqrt(Math.pow(a.clientX - Blockly.Flyout.startDownEvent_.clientX, 2) + Math.pow(b, 2)) > Blockly.DRAG_RADIUS && Blockly.Flyout.startFlyout_.createBlockFunc_(Blockly.Flyout.startBlock_)(Blockly.Flyout.startDownEvent_)
    }
};
...
Blockly.Toolbox.prototype.init = function() {
    ...
    this.CONFIG_.cssCollapsedFolderIcon = "blocklyTreeIconClosed" + (this.workspace_.RTL ? "Rtl" : "Ltr");
        ...
        for (var f = 0, g; g = a.childNodes[f]; f++)
            if (g.tagName) switch (g.tagName.toUpperCase()) {
                case "CATEGORY":
                    ...
                    k ? h.blocks = k : b(g, h);
                    "true" == g.getAttribute("expanded") && (h.blocks.length && c.setSelectedItem(h), h.setExpanded(!0));
                    break;
                case "SEP":
...
Blockly.Toolbox.TreeControl.prototype.setSelectedItem = function(a) {
    ...
    if (this.selectedItem_ != a) {
        ...
        var b = this.toolbox_;
        a && a.blocks && a.blocks.length ? (b.flyout_.show(a.blocks), b.lastCategory_ != a.blocks && (b.flyout_.scrollToTop(), b.lastCategory_ = a.blocks)) : b.flyout_.hide()
    }
};
...
Blockly.Css.setCursor = function(a) {
    if (Blockly.Css.currentCursor_ != a) {
        ...
        var b = "url(" + Blockly.Css.mediaPath_ + "/" + a + ".cur) " + (a == Blockly.Css.Cursor.OPEN ? "8 5" : "7 3") + ", auto";
        goog.cssom.replaceCssRule("", ".blocklyDraggable {\n  cursor: " + b + ";\n}\n", Blockly.Css.styleSheet_, 0);
        for (var c = document.getElementsByClassName("blocklyToolboxDiv"), d = 0, e; e = c[d]; d++) e.style.cursor = a == Blockly.Css.Cursor.OPEN ? "" : b;
...
Blockly.Css.CONTENT = [".blocklySvg {", "  background-color: #fff;", "  outline: none;", "  overflow: hidden;", "}", ".blocklyWidgetDiv {", "  display: none;", "  position: absolute;", "  z-index: 999;", "}", ".blocklyTooltipDiv {", "  background-color: #ffffc7;", "  border: 1px solid #ddc;", "  box-shadow: 4px 4px 20px 1px rgba(0,0,0,.15);", "  color: #000;", "  display: none;", "  font-family: sans-serif;", "  font-size: 9pt;", "  opacity: 0.9;", "  padding: 2px;", "  position: absolute;", "  z-index: 1000;", "}", ".blocklyResizeSE {",
    ...
    "}", ".blocklyMainBackground {", "  stroke-width: 1;", "  stroke: #c6c6c6;", "}", ".blocklyMutatorBackground {", "  fill: #fff;", "  stroke: #ddd;", "  stroke-width: 1;", "}", ".blocklyFlyoutBackground {", "  fill: #BDB7B1;", "  fill-opacity: .8;", "}", ".blocklyScrollbarBackground {", "  opacity: 0;", "}", ".blocklyScrollbarKnob {", "  fill: #ccc;", "}", ".blocklyScrollbarBackground:hover+.blocklyScrollbarKnob,", ".blocklyScrollbarKnob:hover {", "  fill: #bbb;", "}", ".blocklyFlyout .blocklyScrollbarKnob {", "  fill: #bbb;",
    ...
    "}", ".blocklyContextMenu {", "  border-radius: 4px;", "}", ".blocklyDropdownMenu {", "  padding: 0 !important;", "}", ".blocklyWidgetDiv .goog-option-selected .goog-menuitem-checkbox,", ".blocklyWidgetDiv .goog-option-selected .goog-menuitem-icon {", "  background: url(<<<PATH>>>/sprites.png) no-repeat -48px -16px !important;", "}", ".blocklyToolboxDiv {", "  background-color: #bcac99;", "  overflow-x: visible;", "  overflow-y: auto;", "  position: absolute;", "}", ".blocklyTreeRoot {", "  padding: 4px 0;", "}", ".blocklyTreeRoot:focus {",
    "  outline: none;", "}", ".blocklyTreeRow {", "  line-height: 22px;", "  height: 22px;", "  padding-right: 1em;", "  white-space: nowrap;", "}", '.blocklyToolboxDiv[dir="RTL"] .blocklyTreeRow {', "  padding-right: 0;", "  padding-left: 1em !important;", "}", ".blocklyTreeRow:hover {", "  background-color: #9e846d;", "}", ".blocklyTreeSeparator {", "  border-bottom: solid #e5e5e5 1px;", "  height: 0px;", "  margin: 5px 0;", "}", ".blocklyTreeIcon {", "  background-image: url(<<<PATH>>>/sprites.png);", "  height: 16px;",
    ...
    "}", ".blocklyTreeIconNone,", ".blocklyTreeSelected>.blocklyTreeIconNone {", "  background-position: -48px -1px;", "}", ".blocklyTreeLabel {", "  cursor: default;", "  color: white;", " font-family: sans-serif;", "  font-size: 16px;", "  padding: 0 3px;", "  vertical-align: middle;", "}", ".blocklyTreeSelected  {", "  background-color: #9e846d !important;", "}", ".blocklyTreeSelected .blocklyTreeLabel {", "  color: #fff;", "}", ".blocklyWidgetDiv .goog-palette {", "  outline: none;", "  cursor: default;", "}", ".blocklyWidgetDiv .goog-palette-table {",
...
Blockly.createDom_ = function(a, b) {
    ...
    var c = Blockly.createSvgElement("svg", {
        ...
        e, f;
    e = Blockly.createSvgElement("filter", {
        id: "blocklyEmboss"
    }, d);
    ...
    f = Blockly.createSvgElement("feSpecularLighting", {
        "in": "blur",
        surfaceScale: 1,
        specularConstant: .5,
        specularExponent: 10,
    ...
    e = Blockly.createSvgElement("pattern", {
    ...
    if (0 < b.gridOptions.length && 0 < b.gridOptions.spacing) {
        e = Math.floor(b.gridOptions.spacing / 2) + .5;
...
Blockly.createMainWorkspace_ = function(a, b) {
    ...
    b.readOnly || b.hasScrollbars || c.addChangeListener(function() {
        if (0 == Blockly.dragMode_) {
            ...
            if (a.contentTop < f || a.contentTop + a.contentHeight > a.viewHeight + f || a.contentLeft < (b.RTL ?
                    a.viewLeft : e) || a.contentLeft + a.contentWidth > (b.RTL ? a.viewWidth : a.viewWidth + e))
...
Blockly.init_ = function(a) {
    ...
    Blockly.documentEventsBound_ || (Blockly.bindEvent_(document, "keydown", null, Blockly.onKeyDown_), Blockly.bindEvent_(document, "touchend", null, Blockly.longStop_), Blockly.bindEvent_(document, "touchcancel", null, Blockly.longStop_), document.addEventListener("mouseup", Blockly.onMouseUp_,
        !1), goog.userAgent.IPAD && Blockly.bindEvent_(window, "orientationchange", document, function() {
        Blockly.fireUiEvent(window, "resize")
...
Blockly.getRelativeXY_ = function(a) {
    ...
    if (a = (a = a.getAttribute("transform")) && a.match(/translate\(\s*([-\d.]+)([ ,]\s*([-\d.]+)\s*\))?/)) b.x += parseFloat(a[1]), a[3] && (b.y += parseFloat(a[3]));
    return b
};
...
Blockly.onKeyDown_ = function(a) {
    if (!Blockly.isTargetInput_(a))
        ...
        a.preventDefault()
    } else if (a.altKey || a.ctrlKey || a.metaKey) Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() && (Blockly.hideChaff(), 67 == a.keyCode ? Blockly.copy_(Blockly.selected) : 88 == a.keyCode && (Blockly.copy_(Blockly.selected),
        Blockly.selected.dispose(!0, !0))), 86 == a.keyCode && Blockly.clipboardXml_ && Blockly.clipboardSource_.paste(Blockly.clipboardXml_)
};
...
Blockly.getMainWorkspaceMetrics_ = function() {
    ...
    if (this.scrollbar) var f = this.RTL ? 0 : Blockly.Scrollbar.scrollbarThickness,
        g = Math.min(d.x - b / 2, d.x + d.width - b - (this.RTL ? Blockly.Scrollbar.scrollbarThickness : 0) + 5),
        b = Math.max(d.x + d.width + b / 2, d.x + b + f - 5),
        f = Math.min(d.y - c / 2,
            d.y + d.height - c + 5),
        c = Math.max(d.y + d.height + c / 2, d.y + c + Blockly.Scrollbar.scrollbarThickness - 5);
...
Blockly.setMainWorkspaceMetrics_ = function(a) {
    ...
    this.translate(a, b);
    this.options.gridPattern && (this.options.gridPattern.setAttribute("x", a), this.options.gridPattern.setAttribute("y", b))
};
