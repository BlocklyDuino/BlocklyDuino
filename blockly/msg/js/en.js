...
Blockly.Msg.CUSTOM_ANALOG = "Analog";
Blockly.Msg.CUSTOM_ARDUINO = "Arduino";
Blockly.Msg.CUSTOM_BLOCKS = "Blocks";
Blockly.Msg.CUSTOM_CONTROL = "Control";
Blockly.Msg.CUSTOM_DIGITAL = "Digital";
Blockly.Msg.CUSTOM_FAKELOAD = "Load Sketch";
Blockly.Msg.CUSTOM_FUNCTIONS = "Functions";
Blockly.Msg.CUSTOM_INPUT_OUTPUT = "Input/output";
Blockly.Msg.CUSTOM_LED = "Led";
Blockly.Msg.CUSTOM_LOGIC = "Logic";
Blockly.Msg.CUSTOM_MATH = "Math";
Blockly.Msg.CUSTOM_OLED = "Oled";
Blockly.Msg.CUSTOM_RESET_ARDUINO = "Reset Arduino";
Blockly.Msg.CUSTOM_RESET_SKETCH = "Reset Sketch";
Blockly.Msg.CUSTOM_SAVE_ARDUINO_CODE = "Save Arduino Code";
Blockly.Msg.CUSTOM_SAVE_SKETCH = "Save Sketch";
Blockly.Msg.CUSTOM_SERIAL = "Serial";
Blockly.Msg.CUSTOM_TEXT = "Text";
Blockly.Msg.CUSTOM_TONE = "Tone";
Blockly.Msg.CUSTOM_TUNES = "Tunes";
Blockly.Msg.CUSTOM_UPLOAD_TO_ARDUINO = "Upload to Arduino";
Blockly.Msg.CUSTOM_VARIABLES = "Variables";
...
Blockly.Msg.OLED_HELPURL = "";
Blockly.Msg.OLED_IMAGE_KIDSPEAK = "Kidspeak";
Blockly.Msg.OLED_IMAGE_TRETTON37 = "tretton37";
Blockly.Msg.OLED_INVERT = "Invert";
Blockly.Msg.OLED_PRINT = "Print";
Blockly.Msg.OLED_PRINT_HEIGHT = "Height";
Blockly.Msg.OLED_PRINT_IMAGE = "Image";
Blockly.Msg.OLED_PRINT_TEXT = "Text";
Blockly.Msg.OLED_PRINT_WIDTH = "Width";
Blockly.Msg.OLED_PRINT_X = "X";
Blockly.Msg.OLED_PRINT_Y = "Y";
...
Blockly.Msg.TUNES_HELPURL = "";
Blockly.Msg.TUNES_PLAY = "Play tune";
